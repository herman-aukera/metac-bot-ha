...
class BaseAgent(ABC):
    def __init__(self, name: str, llm_client: Any, search_client: Any | None = None, model_config: Dict[str, Any] | None = None):
        self.name = name
    ...
    @abstractmethod
    async def conduct_research(self, question_text: str, search_config: Optional[Dict[str, Any]] = None) -> str: # Returns ResearchReport content
        pass

    @abstractmethod
    async def generate_prediction(self, question_text: str, research_summary: str) -> Dict[str, Any]: # Returns Prediction content
        pass

    async def forecast(self, question_text: str, search_config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        research_summary = await self.conduct_research(question_text, search_config)
        prediction_details = await self.generate_prediction(question_text, research_summary)
...
class ChainOfThoughtAgent(BaseAgent):
    async def conduct_research(self, question_text: str, search_config: Optional[Dict[str, Any]] = None) -> str:
    ...
    async def generate_prediction(self, question_text: str, research_summary: str) -> Dict[str, Any]:
