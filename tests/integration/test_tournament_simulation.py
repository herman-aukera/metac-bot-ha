...
from src.infrastructure.external_apis.submission_validator import DryRunManager, SubmissionValidator
...
class TestTournamentSimulation:
    ...
    def test_submission_simulation(self):
        ...
        session_id = self.dry_run_manager.start_dry_run_session(
            session_name="Submission Test",
            tournament_context={"budget_limit": 50.0}
        )
    ...
    def test_tournament_workflow_simulation(self):
        ...
        for question in questions:
            ...
            prediction.probability = Probability(0.6 + (0.1 * len(results)))  # Vary predictions
    ...
    def test_scheduling_optimization_simulation(self):
        ...
        for question in questions:
            ...
            schedule_time = question.close_time - timedelta(hours=2)  # 2 hours before close
