...
class TestDispatcher:
    ...
    def test_fetch_questions_success(self):
        ...
        with patch.object(dispatcher.api, 'fetch_questions', return_value=mock_questions_json):
    ...
    def test_fetch_questions_api_error(self):
        ...
        with patch.object(dispatcher.api, 'fetch_questions', side_effect=MetaculusAPIError("API Error")):
            result = dispatcher._fetch_questions(limit=2, status="open", category=None)
    ...
    def test_parse_questions_success(self, sample_questions):
        ...
        with patch.object(dispatcher.ingestion_service, 'parse_questions', 
    ...
    def test_generate_forecasts_success(self, sample_questions, sample_forecast):
        ...
        with patch.object(dispatcher.forecast_service, 'generate_forecast', 
    ...
    def test_run_success(self, sample_questions, sample_forecast):
        ...
        with patch.object(dispatcher.api, 'fetch_questions', return_value=mock_questions_json), \
             patch.object(dispatcher.ingestion_service, 'parse_questions', 
                         return_value=(sample_questions, mock_ingestion_stats)), \
             patch.object(dispatcher.forecast_service, 'generate_forecast', 
                         return_value=sample_forecast):
    ...
    def test_run_with_critical_error(self):
        ...
        with patch.object(dispatcher.api, 'fetch_questions', 
    ...
    def test_run_batch_success(self, sample_questions, sample_forecast):
        ...
        with patch.object(dispatcher, 'run', return_value=([sample_forecast], mock_stats)):
