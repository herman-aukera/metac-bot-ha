...
class TestQuestion:
    ...
    def test_multiple_choice_validation_error(self):
        ...
        with pytest.raises(ValueError, match="Multiple choice questions must have choices"):
            Question(
                id=uuid4(),
                metaculus_id=12346,
                title="Test question",
    ...
    def test_numeric_validation_error(self):
        ...
        with pytest.raises(ValueError, match="Numeric questions must have min and max values"):
            Question(
                id=uuid4(),
                metaculus_id=12347,
                title="Test question",
