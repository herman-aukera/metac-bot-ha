...
class TestConservativeStrategyEngine:
    ...
    def test_engine_initialization(
        self, config, uncertainty_quantifier, calibration_tracker
    ):
    ...
    def test_assess_prediction_risk_low_risk(
        self, engine, sample_prediction, uncertainty_quantifier
    ):
        ...
        low_uncertainty = UncertaintyAssessment(
            ...
            uncertainty_sources={
                UncertaintySource.EPISTEMIC: 0.1,
        ...
        uncertainty_quantifier.assess_prediction_uncertainty.return_value = (
            low_uncertainty
        )
    ...
    def test_assess_prediction_risk_high_risk(
        self, engine, sample_prediction, uncertainty_quantifier
    ):
        ...
        high_uncertainty = UncertaintyAssessment(
            ...
            uncertainty_sources={
                UncertaintySource.EPISTEMIC: 0.5,
                UncertaintySource.MODEL: 0.4,
            },
        ...
        assert risk_assessment.overall_risk in [
            RiskLevel.MODERATE,
            RiskLevel.HIGH,
            RiskLevel.VERY_HIGH,
        ]
        assert risk_assessment.recommended_action in [
            ...
            ConservativeAction.REQUEST_RESEARCH,
        ]

    def test_assess_prediction_risk_with_tournament_context(
        ...
        risk_assessment = engine.assess_prediction_risk(
            sample_prediction, tournament_context=tournament_context
        )
    ...
    def test_apply_conservative_strategy_submit(self, engine, sample_forecast):
        ...
        adjusted_forecast, strategy_report = engine.apply_conservative_strategy(
            sample_forecast
        )
    ...
    def test_apply_conservative_strategy_reduce_confidence(
        self, engine, sample_forecast, uncertainty_quantifier
    ):
        ...
        moderate_uncertainty = UncertaintyAssessment(
            ...
            uncertainty_sources={
                UncertaintySource.EPISTEMIC: 0.4,
                UncertaintySource.MODEL: 0.2,
            },
        ...
        uncertainty_quantifier.assess_forecast_uncertainty.return_value = (
    ...
    def test_should_abstain_from_prediction_high_risk(
        self, engine, sample_prediction, uncertainty_quantifier
    ):
        ...
        very_high_uncertainty = UncertaintyAssessment(
            ...
            uncertainty_sources={
                UncertaintySource.EPISTEMIC: 0.6,
                UncertaintySource.MODEL: 0.35,
            },
    ...
    def test_should_abstain_from_prediction_low_risk(
        self, engine, sample_prediction, uncertainty_quantifier
    ):
        ...
        low_uncertainty = UncertaintyAssessment(
            ...
            uncertainty_sources={
                UncertaintySource.EPISTEMIC: 0.05,
                UncertaintySource.MODEL: 0.05,
            },
    ...
    def test_should_abstain_with_tournament_penalty(
        self, engine, sample_prediction, uncertainty_quantifier
    ):
        ...
        assert (
            abstention_result["tournament_considerations"]["abstention_penalty"] == 0.75
        )  # 0.5 * 1.5 (final phase)
    ...
    def test_optimize_tournament_scoring(self, engine, sample_prediction):
        ...
        optimization_results = engine.optimize_tournament_scoring(
            predictions, tournament_context
        )
    ...
    def test_update_strategy_based_on_performance(self, engine):
        ...
        assert (
            engine.config.abstention_uncertainty_threshold >= original_threshold * 0.9
        )
    ...
    def test_risk_level_determination(self, engine):
        ...
        assert risk_level in [
            RiskLevel.HIGH,
            RiskLevel.VERY_HIGH,
        ]  # Allow for both high and very high
        ...
        assert risk_level in [
            RiskLevel.VERY_LOW,
            RiskLevel.LOW,
        ]  # Allow for both very low and low
    ...
    def test_abstention_penalty_calculation(self, engine):
        ...
        final_phase_context = {"abstention_penalty": 0.2, "phase": "final"}
        ...
        early_phase_context = {"abstention_penalty": 0.2, "phase": "early"}
    ...
    def test_confidence_adjustment_application(self, engine, sample_prediction):
        ...
        adjusted_prediction = engine._apply_confidence_adjustment(
            sample_prediction, adjustment_factor
        )
    ...
    def test_competitive_impact_calculation(self, engine):
        ...
        impact = engine._calculate_competitive_impact(
            ConservativeAction.ABSTAIN, high_competition_context
        )
        assert impact < -0.3  # Negative impact

        # Submitting has no negative impact
        impact = engine._calculate_competitive_impact(
            ConservativeAction.SUBMIT, high_competition_context
        )
        assert impact == 0.0
