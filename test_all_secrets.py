#!/usr/bin/env python3
"""
Comprehensive API Secrets Test
...
async def test_metaculus_api():
    ...
    try:
        ...
        async with aiohttp.ClientSession(connector=connector) as session:
            # Test user profile endpoint (try different possible endpoints)
            profile_endpoints = [
                "https://www.metaculus.com/api2/accounts/profile/",
                "https://www.metaculus.com/api/accounts/profile/",
                "https://www.metaculus.com/api2/user/",
                "https://www.metaculus.com/api/user/",
                "https://www.metaculus.com/api2/me/",
                "https://www.metaculus.com/api/me/"
            ]
            headers = {
...
async def main():
    """Main test execution."""
    print("🚀 Comprehensive API Secrets Test")
