...
description: 'Generate a detailed Product Requirements Document (PRD) based on user input'
---

# Generate Product Requirements Document (PRD)

Your goal is to create a detailed Product Requirements Document (PRD) in Markdown format based on an initial user prompt. The PRD should be clear, actionable, and suitable for a junior developer to understand and implement the feature.
...
4. Generate the final PRD document based on all gathered information
